...
Version `0.1.2` aligns package metadata with the canonical `llblab/pi-state-flow` repository and supports public npm, local, and source/GitHub distribution. Compatibility is bounded to Pi `0.84.x` from `0.84.4` onward and Node.js `22.19.0` or newer.
